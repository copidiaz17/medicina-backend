...
const ESPECIALIDADES = {
  ...
  dermatologia: {
    label: 'Dermatología',
    persona: 'dermatólogo especialista con más de 30 años de experiencia clínica',
    alertas: 'Destacá signos de melanoma (ABCDE), síndrome de Stevens-Johnson, necrólisis epidérmica tóxica, dermatosis paraneoplásicas, celulitis grave o vasculitis con compromiso sistémico que requieran atención urgente.',
    estudios: 'Dermatoscopía, biopsia cutánea con histopatología, cultivo de lesiones (bacterias, hongos), prueba de Tzanck, KOH directo, IFD/IFI, VDRL, ANA y FAN si sospecha autoinmune, hemograma con eosinófilos, IgE total.',
    tratamiento: 'Corticoides tópicos (potencia según zona), antibióticos tópicos/sistémicos, antifúngicos, antihistamínicos, retinoides, inmunomoduladores (tacrolimus, pimecrolimus), fototerapia, biológicos (dupilumab, adalimumab) según patología.',
    seguimiento: 'Control de lesiones con fotografía clínica y dermatoscopía, respuesta al tratamiento, efectos adversos de corticoides crónicos, mapeo de nevos en pacientes de riesgo, fotoprotección.',
  },
  infectologia: {
    label: 'Infectología',
    persona: 'infectólogo especialista con más de 30 años de experiencia clínica',
    alertas: 'Destacá criterios de sepsis (qSOFA ≥2), meningitis bacteriana, endocarditis, neumonía grave, infección por gérmenes multirresistentes, síndrome febril sin foco en inmunocomprometidos o cuadros que requieran internación urgente.',
    estudios: 'Hemocultivos (×2 antes de antibióticos), urocultivo, cultivo de secreciones, PCR para patógenos específicos, serología (HIV, hepatitis, CMV, EBV, toxoplasma, Chagas), radiografía de tórax, TC según foco, laboratorio con PCR/VSG/procalcitonina, punción lumbar si meningitis.',
    tratamiento: 'Antibióticoterapia empírica según foco y escalada de riesgo, luego dirigida por cultivo y antibiograma. Antifúngicos, antivirales o antiparasitarios según etiología. Principios de uso racional de antimicrobianos y desescalada.',
    seguimiento: 'Evolución clínica y de parámetros inflamatorios, resultado de cultivos, adecuación del esquema antibiótico, duración del tratamiento, control de foco, profilaxis en inmunocomprometidos.',
  },
  nefrologia: {
    label: 'Nefrología',
    persona: 'nefrólogo especialista con más de 30 años de experiencia clínica',
    alertas: 'Destacá injuria renal aguda (IRA) con criterios de diálisis urgente (hiperpotasemia grave, acidosis severa, sobrecarga hídrica, uremia sintomática), síndrome nefrótico agudo, glomerulonefritis rápidamente progresiva o crisis hipertensiva con daño renal.',
    estudios: 'Creatinina, urea, ionograma (K+, Na+, HCO3-), clearance de creatinina/TFGe (CKD-EPI), sedimento urinario, proteinuria en orina de 24h o índice prot/creat, ecografía renal y vías urinarias, complemento (C3/C4), ANA, ANCA, biopsia renal si indicada.',
    tratamiento: 'Manejo de IRA (hidratación, suspensión de nefrotóxicos, diálisis si indicada), tratamiento de ERC (control de PA, HbA1c, proteinuria, anemia renal con EPO/hierro, quelantes de fósforo), inmunosupresión en glomerulopatías, manejo del síndrome nefrótico.',
    seguimiento: 'TFGe y proteinuria cada 3-6 meses, ionograma, PA, anemia, metabolismo óseo-mineral, preparación y monitoreo en diálisis o trasplante renal.',
  },
  oftalmologia: {
    label: 'Oftalmología',
    persona: 'oftalmólogo especialista con más de 30 años de experiencia clínica',
    alertas: 'Destacá pérdida brusca de visión (oclusión de arteria/vena retiniana, desprendimiento de retina, neuritis óptica), glaucoma agudo de ángulo cerrado, endoftalmitis, traumatismo ocular penetrante o celulitis orbitaria que requieran atención oftalmológica urgente.',
    estudios: 'Agudeza visual, biomicroscopía con lámpara de hendidura, tonometría, fondo de ojo, campimetría, OCT (tomografía de coherencia óptica), angiografía fluoresceínica, ecografía ocular, PIO.',
    tratamiento: 'Colirios hipotensores (betabloqueantes, análogos de prostaglandinas, inhibidores de AC) en glaucoma, corticoides tópicos/sistémicos en inflamación, antiangiogénicos intravítreos (ranibizumab, bevacizumab) en DMAE húmeda y retinopatía diabética, cirugía según indicación.',
    seguimiento: 'Control de PIO y campo visual en glaucoma, fondo de ojo en diabéticos (anual o según estadio), AV y OCT en patología macular, adherencia a colirios.',
  },
  otorrinolaringologia: {
    label: 'Otorrinolaringología',
    persona: 'otorrinolaringólogo especialista con más de 30 años de experiencia clínica',
    alertas: 'Destacá parálisis facial periférica aguda (Bell, Ramsay Hunt), hipoacusia súbita neurosensorial (emergencia ORL), epiglotitis aguda, absceso periamigdalino o retrofaríngeo, epistaxis masiva o vértigo con signos neurológicos centrales que requieran atención urgente.',
    estudios: 'Otoscopía, audiometría tonal y vocal, impedanciometría, BERA, videonistagmoscopía en vértigo, nasofibroscopía, TC de peñasco/senos paranasales/cuello, RMN si compromiso de nervio facial o SNC.',
    tratamiento: 'Corticoides sistémicos en hipoacusia súbita y parálisis facial, antibióticos en otitis media aguda/sinusitis bacteriana, antifúngicos en otomicosis, manejo del vértigo (maniobras de reposicionamiento, betahistina), drenaje quirúrgico de abscesos.',
    seguimiento: 'Audiometría de control, respuesta al tratamiento en hipoacusia súbita (72h y 1 mes), evolución de parálisis facial (escala de House-Brackmann), control de sinusitis crónica.',
  },
  psiquiatria: {
    label: 'Psiquiatría',
    persona: 'psiquiatra especialista con más de 30 años de experiencia clínica',
    alertas: 'Destacá riesgo de suicidio o autolesión (ideación, plan, intención, acceso a medios), agitación psicomotriz grave, síndrome neuroléptico maligno, manía con riesgo heteroagresivo, psicosis aguda con pérdida de contacto con la realidad o primer episodio psicótico que requieran internación.',
    estudios: 'Evaluación clínica con escalas validadas (PHQ-9, GAD-7, MADRS, YMRS, PANSS, MMSE), laboratorio para descartar causas orgánicas (TSH, glucemia, ionograma, función hepática/renal, vitamina B12, folato, VDRL, HIV), EEG y neuroimagen si primer episodio o atipicidad.',
    tratamiento: 'Antidepresivos (ISRS, IRSN, tricíclicos según perfil), estabilizadores del ánimo (litio, valproato, lamotrigina), antipsicóticos (típicos y atípicos), ansiolíticos (benzodiacepinas con precaución), psicoterapia (TCC, DBT) como complemento farmacológico.',
    seguimiento: 'Escalas de respuesta clínica, adherencia al tratamiento, efectos adversos (síndrome metabólico con antipsicóticos, litemia), prevención de recaídas, red de apoyo y psicoeducación familiar.',
  },
  reumatologia: {
    label: 'Reumatología',
    persona: 'reumatólogo especialista con más de 30 años de experiencia clínica',
    alertas: 'Destacá artritis séptica (emergencia), crisis de lupus con compromiso renal/SNC/hematológico, vasculitis sistémica grave, síndrome antifosfolípido con trombosis, crisis gotosa con compromiso poliarticular o miositis grave con insuficiencia respiratoria.',
    estudios: 'FAN (ANA), anti-DNA, anti-Sm, anti-Ro/La, FR, anti-CCP, ANCA, complemento (C3/C4), VSG, PCR, hemograma, función renal y hepática, uricemia, punción articular con análisis de líquido sinovial, radiografías articulares, ecografía musculoesquelética, RMN.',
    tratamiento: 'AINEs, corticoides (sistémicos y locales), antipalúdicos (hidroxicloroquina), metotrexato, leflunomida, sulfasalazina, biológicos (anti-TNF, anti-IL6, anti-CD20, abatacept), uricostáticos (alopurinol, febuxostat) en gota.',
    seguimiento: 'Actividad de la enfermedad con scores validados (DAS28, SLEDAI, HAQ), control de toxicidad de metotrexato (hemograma y hepatograma cada 3 meses), densitometría en corticoterapia crónica, vacunación en inmunosuprimidos.',
  },
  urologia: {
    label: 'Urología',
    persona: 'urólogo especialista con más de 30 años de experiencia clínica',
    alertas: 'Destacá torsión testicular (emergencia quirúrgica en <6h), cólico renal con sepsis urinaria, retención aguda de orina, hematuria macroscópica con coágulos, priapismo o trauma genitourinario que requieran intervención urgente.',
    estudios: 'Urocultivo, creatinina, PSA total y libre, ecografía renal y vesical con residuo postmiccional, uroflujometría, urografía por TC, cistoscopía, biopsia prostática guiada por ecografía o RMN, RMN de próstata multiparamétrica.',
    tratamiento: 'Alfabloqueantes (tamsulosina) e inhibidores de 5-alfa-reductasa en HBP, antibióticos en ITU/prostatitis, litotripsia o cirugía en litiasis, instilaciones vesicales en vejiga hiperactiva, hormonoterapia y quimioterapia en cáncer de próstata avanzado.',
    seguimiento: 'PSA y tacto rectal en cáncer de próstata, urocultivos de control post-ITU recurrente, función renal en uropatía obstructiva, seguimiento cistoscópico en cáncer vesical no músculo-invasivo.',
  },
  hematologia: {
    label: 'Hematología',
    persona: 'hematólogo especialista con más de 30 años de experiencia clínica',
    alertas: 'Destacá neutropenia febril (emergencia oncohematológica), anemia grave sintomática (Hb <7 con inestabilidad), síndrome de lisis tumoral, CID, trombocitopenia grave con sangrado activo (<20.000), crisis vasooclusiva en anemia de células falciformes o leucemia aguda.',
    estudios: 'Hemograma completo con fórmula leucocitaria, reticulocitos, extendido de sangre periférica, coagulograma (TP, KPTT, fibrinógeno, dímero D), LDH, ácido úrico, haptoglobina, Coombs directo, ferritina, vitamina B12, folato, electroforesis de proteínas, biopsia de médula ósea si indicada, citometría de flujo, citogenética.',
    tratamiento: 'Hierro oral/EV en anemia ferropénica, vitamina B12/folato en anemias megaloblásticas, EPO en anemia renal, transfusiones según indicación, corticoides en PTI/anemia hemolítica autoinmune, quimioterapia/inmunoterapia en neoplasias hematológicas, anticoagulación en trombosis.',
    seguimiento: 'Hemograma de control según patología, niveles de hierro/B12 post-tratamiento, respuesta a quimioterapia (remisión completa/parcial), monitoreo de toxicidad hematológica.',
  },
  geriatria: {
    label: 'Geriatría',
    persona: 'geriatra especialista con más de 30 años de experiencia en medicina del anciano',
    alertas: 'Destacá síndrome confusional agudo (delirium), caída con sospecha de fractura, polifarmacia con interacciones graves, deshidratación severa, úlceras por presión grado III-IV, desnutrición grave o síndrome de inmovilización que requieran evaluación urgente.',
    estudios: 'Valoración geriátrica integral (cognitiva: MMSE/MoCA, funcional: Barthel/Lawton, nutricional: MNA, riesgo de caídas: Tinetti/Timed Up and Go), laboratorio completo con TSH, vitamina D, B12, hemograma, función renal/hepática, ionograma, ECG, densitometría.',
    tratamiento: 'Principios de prescripción geriátrica (criterios STOPP/START), deprescripción de fármacos inapropiados, rehabilitación funcional, suplementación con vitamina D y calcio, manejo del dolor crónico evitando AINEs, tratamiento de síndromes geriátricos (caídas, delirium, úlceras).',
    seguimiento: 'Valoración funcional y cognitiva periódica, control de polifarmacia, adherencia al tratamiento, estado nutricional, red de apoyo social y cuidadores, prevención de caídas y úlceras por presión.',
  },
  emergentologia: {
    label: 'Emergentología / Urgencias',
    persona: 'médico emergentólogo especialista con más de 30 años de experiencia en medicina de urgencias y emergencias',
    alertas: 'Destacá cualquier condición que amenace la vida de forma inmediata: paro cardiorrespiratorio, shock (séptico, hipovolémico, cardiogénico, anafiláctico), insuficiencia respiratoria aguda, ACV en ventana terapéutica, politrauma, intoxicación grave o abdomen agudo quirúrgico.',
    estudios: 'ECG en 10 minutos, lactato, gases arteriales, hemograma, coagulograma, función renal/hepática, ionograma, glucemia, troponina, BNP, dímero D, radiografía de tórax, ecografía FAST en trauma, TC según clínica. Priorizar estudios según estabilidad hemodinámica.',
    tratamiento: 'Estabilización ABCDE (vía aérea, ventilación, circulación, déficit neurológico, exposición). RCP según guías AHA/ILCOR, manejo del shock (fluidos, vasopresores), fibrinólisis o derivación para intervencionismo en SCA/ACV, antídotos en intoxicaciones, analgesia y sedación procedural.',
    seguimiento: 'Reevaluación continua del paciente crítico, criterios de alta vs internación vs UCI, comunicación con especialistas de guardia, traslado seguro si corresponde.',
  },
  cirugia_general: {
    label: 'Cirugía General',
    persona: 'cirujano general especialista con más de 30 años de experiencia clínica y quirúrgica',
    alertas: 'Destacá abdomen agudo quirúrgico (apendicitis perforada, peritonitis, isquemia mesentérica, hernia estrangulada, oclusión intestinal), hemorragia digestiva masiva, perforación visceral o trauma abdominal con inestabilidad hemodinámica que requieran intervención quirúrgica urgente.',
    estudios: 'Laboratorio con hemograma, coagulograma, función hepática/pancreática (amilasa, lipasa), grupo y factor, ecografía abdominal, TC de abdomen y pelvis con contraste, radiografía de abdomen en bipedestación, endoscopía diagnóstica/terapéutica según indicación.',
    tratamiento: 'Manejo preoperatorio (ayuno, hidratación, antibióticos profilácticos), técnica quirúrgica según patología (laparoscopía vs cirugía abierta), manejo postoperatorio (analgesia, deambulación precoz, prevención de TVP), tratamiento de complicaciones (fístulas, dehiscencia, infección de herida).',
    seguimiento: 'Control postoperatorio de herida, función intestinal, complicaciones tardías (eventraciones, adherencias), patología oncológica: márgenes, estadificación y derivación a oncología.',
  },
  nutricion: {
    label: 'Nutrición y Dietología',
    persona: 'médico nutricionista y dietólogo especialista con más de 30 años de experiencia clínica',
    alertas: 'Destacá desnutrición grave (IMC <16, pérdida >10% del peso en 1 mes), síndrome de realimentación, trastornos de la conducta alimentaria con compromiso hemodinámico (anorexia nerviosa grave), obesidad mórbida con comorbilidades descompensadas o disfagia con riesgo de broncoaspiración.',
    estudios: 'Antropometría completa (peso, talla, IMC, circunferencia de cintura, pliegues cutáneos), bioimpedanciometría, laboratorio nutricional (albúmina, prealbúmina, transferrina, hemograma, ionograma, glucemia, perfil lipídico, vitamina D, B12, folato, hierro, zinc), calorimetría indirecta si disponible.',
    tratamiento: 'Plan alimentario individualizado según patología y objetivos, suplementación oral/enteral/parenteral según grado de desnutrición, tratamiento farmacológico de obesidad (orlistat, semaglutida), educación alimentaria, manejo de trastornos de conducta alimentaria en equipo multidisciplinario.',
    seguimiento: 'Control de peso y composición corporal, parámetros bioquímicos nutricionales, adherencia al plan alimentario, ajuste de suplementos, evolución de comorbilidades metabólicas (HTA, DBT, dislipemia).',
  },
  alergologia: {
